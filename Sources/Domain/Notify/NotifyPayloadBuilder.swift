...
/// Turns quota readings into the tile and gauge AgentBar publishes to Notify!.
///
...
///    "Claude 5h  Claude 7d".
/// 4. Percentages are remaining, not used. Every AgentBar surface reads that
...
public struct NotifyPayloadBuilder: Sendable {
    ...
    public static let defaultTitle = "AgentBar"
