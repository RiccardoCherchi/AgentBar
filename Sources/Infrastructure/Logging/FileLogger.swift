...
/// File-based logger that writes to ~/Library/Logs/AgentBar/AgentBar.log
...
public final class FileLogger: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.tddworks.AgentBar.FileLogger")
    ...
    private init() {
        ...
        self.fileURL = logsDir.appendingPathComponent("AgentBar.log")
    }
